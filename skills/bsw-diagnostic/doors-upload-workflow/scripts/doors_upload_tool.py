#!/usr/bin/env python
"""
Upload an Excel file to a DOORS module via MCP.
"""
...
def initialize_session(server_url: str, timeout: int) -> Optional[str]:
    ...
    body = {
        ...
        "params": {
            ...
            "capabilities": {},
            "clientInfo": {"name": "doors-upload-client", "version": "1.1.0"},
        },
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Upload DOORS Excel file via MCP.")
